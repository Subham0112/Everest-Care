...
const FormPreview = ({handleAlert}) => {
  ...
  const generateRegularPDF = async () => {
    ...
    try {
      ...
      handleAlert('An error occurred while generating the PDF. Please try again.', "danger");
    }
  };
  ...
  const handleSubmitForm = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        handleAlert(`Form submitted successfully for ${consumerName}.`, "success");
        ...
        handleAlert(result.message || 'Failed to submit form', "danger");
      }
      
    } catch (error) {
      console.error('Error submitting form:', error);
      handleAlert('Failed to submit form. Please try again or contact support.', "danger");
    } finally {
