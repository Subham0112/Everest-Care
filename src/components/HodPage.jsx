...
function HodContent() {
  ...
  // Determine type from current path (UPPERCASE for database match)
                ...
                <div className="content-card p-4 h-100 text-center">
                  ...
                  <div className="mt-3 d-flex justify-content-center gap-3">
                    <button
                      ...
                      onClick={() => navigate(`/home/training/${type.toLowerCase()}/${training.trainingName}`)}
                    >
                      Training
                    </button>
                    <button
                      className="btn btn-custom2"
                      onClick={() => navigate(`/home/quiz/${type.toLowerCase()}/${training.trainingName}`)}
                    >
                      Quiz
                    </button>
                  </div>
